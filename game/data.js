...
const GAME_DATA = {
    ...
    improvements: {
        ...
        oil_plant: { name: 'Oil Power Plant', icon: '🛢️', category: 'power', cost: 8000, maxPerCity: 5, consumes: { oil: 10 }, power: 2000, pollution: 3, upkeep: 250, desc: 'Generates 2,000 MW. Consumes 10 Oil/turn.' },
        ...
        wind_farm: { name: 'Wind Farm', icon: '🌬️', category: 'power', cost: 12000, power: 800, pollution: 0, upkeep: 100, desc: 'Generates 800 MW. Silent and zero pollution.' },
        ...
        aluminum_refinery: { name: 'Aluminum Refinery', icon: '⚙️', category: 'manufacture', cost: 10000, maxPerCity: 2, consumes: { bauxite: 15 }, produces: 'aluminum', rate: 15, upkeep: 200, powerUsage: 600, desc: 'Consumes 15 Bauxite, Produces 15 Aluminum/turn.' },
        ...
        munitions_factory: { name: 'Munitions Factory', icon: '💥', category: 'manufacture', cost: 12000, maxPerCity: 2, consumes: { steel: 10, oil: 5 }, produces: 'munitions', rate: 20, upkeep: 250, powerUsage: 800, desc: 'Consumes 10 Steel & 5 Oil, Produces 20 Munitions/turn.' },
        ...
        factory: { name: 'Arms Factory', icon: '🏭', category: 'military', cost: 20000, maxPerCity: 3, capacity: 100, upkeep: 400, powerUsage: 500, desc: 'Provides 100 supply for Tanks and Artillery.' },
        air_base: { name: 'Air Base', icon: '✈️', category: 'military', cost: 50000, maxPerCity: 2, capacity: 30, upkeep: 1000, powerUsage: 1000, desc: 'Provides 30 supply for Aircraft.' },
    ...
    units: {
        ...
        tanks: { name: 'Tanks', icon: '🛡️', branch: 'Army', strength: 10, defense: 8, speed: 2, cost: { money: 200, steel: 5, munitions: 2 }, maintenance: { money: 10, oil: 0.1 }, requires: 'factory' },
        artillery: { name: 'Artillery', icon: '💣', branch: 'Army', strength: 12, defense: 2, speed: 1, cost: { money: 150, steel: 3, munitions: 3 }, maintenance: { money: 8, munitions: 0.05 }, requires: 'factory' },
        ...
        anti_air: { name: 'Anti-Air Battery', icon: '🔫', branch: 'Army', strength: 3, defense: 15, speed: 1, cost: { money: 100, steel: 2, munitions: 2 }, maintenance: { money: 5, munitions: 0.05 }, requires: 'factory' },
        fighters: { name: 'Fighter Jets', icon: '✈️', branch: 'Air Force', strength: 15, defense: 10, speed: 10, cost: { money: 500, aluminum: 5, oil: 3 }, maintenance: { money: 25, oil: 0.2 }, requires: 'air_base' },
        bombers: { name: 'Bombers', icon: '💥', branch: 'Air Force', strength: 25, defense: 5, speed: 6, cost: { money: 800, aluminum: 8, oil: 5, munitions: 5 }, maintenance: { money: 40, oil: 0.3 }, requires: 'air_base' },
        helicopters: { name: 'Helicopters', icon: '🚁', branch: 'Air Force', strength: 8, defense: 5, speed: 7, cost: { money: 300, aluminum: 3, oil: 2 }, maintenance: { money: 15, oil: 0.15 }, requires: 'air_base' },
        drones: { name: 'Combat Drones', icon: '🤖', branch: 'Air Force', strength: 6, defense: 2, speed: 8, cost: { money: 200, aluminum: 2, rare: 1 }, maintenance: { money: 10 }, requires: 'air_base' },
